  ...
  data() {
    ...
    return {
      ...
      userFormValidate: {
        ...
        idcard: [
          { required: true, message: "身份账号不能为空", trigger: "blur" },
