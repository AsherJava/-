  ...
  <div class="search">
    ...
    <Modal :title="modalTitle" v-model="roleModalVisible" :mask-closable='false' :width="500">
      <Form ref="roleForm" :model="roleForm" :label-width="80" :rules="roleFormValidate">
        ...
        <FormItem label="权限" >
          <Select  v-model="roleForm.route" placeholder="请选择" >
            <Option   value="home-pages" key="home-pages">
              portal页
            </Option>
            <Option   value="home_index" key="home_index">
              管理页
            </Option>
          </Select>
        </FormItem>
  ...
  data() {
    return {
      ...
      roleForm: {
        name: "",
        description: "",
        route: "home-pages"//新增角色关于页面路由的权限
      },
      roleFormValidate: {
