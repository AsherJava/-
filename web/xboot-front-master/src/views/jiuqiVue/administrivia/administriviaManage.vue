    ...
    <div class="search">
        ...
        <Modal :title="modalTitle" v-model="roleModalVisible" :mask-closable='false' :width="500">
               ...
               <!-- <FormItem label="新闻主图" prop="name">
                ...
                <FormItem label="新闻级别" prop="">
                   <!-- <Input v-model="newForm.newsRate" placeholder="级别"/>-->
                        <InputNumber :max="1000" :min=1 v-model="newForm.newsRate"></InputNumber>
            ...
            <Modal :title="mymodalTitle" v-model="myModalVisible" :mask-closable='false' :width="500">
                ...
                <FormItem label="是否置顶" prop="name">
                   <!-- <Input v-model="newXQ.newsIsTop" placeholder="" readonly/>-->
                    <Select  v-model="istop.newIsTop"  placeholder="请选择">
                        <Option   value="0"  >
                            是
                        </Option>
                        <Option   value="1" >
       ...
       <!--njp 20190717新增编辑弹出窗口begin-->
        <Modal :title="BJmodalTitle" v-model="BJModalVisible" :mask-closable='false' :width="500">
            ...
            <Form ref="newXQ" :model="newXQ" :label-width="80" :rules="sysFormValidate">
                ...
                <FormItem label="新闻级别" prop="name">
                    <InputNumber :max="1000" :min=1 v-model="newXQ.newsRate"></InputNumber>
                    <span style="margin-left:5px">值越小越靠前，支持小数</span>
                </FormItem>
                <FormItem label="是否置顶" prop="name">
               ...
               <!-- <Button @click="value3 = true" type="primary">查看主图</Button>-->
                ...
                >
                    <Form :model="formData">
                        ...
                        <Row :gutter="32">
                            <Col span="20">
                               <!-- <FormItem label="主图" label-position="top">-->
                                   <!-- <img class="img-cur" src="../../../assets/jdtp.png" alt="查看" @click="menu2('/')">-->
                                    <div class="box1">
                                       <!-- <img class="img-cur" src="http://127.0.0.1:8888/upload/1564540352657.png" alt="查看" @click="menu2('/')">-->
                                        <img class="new-child-img" :src="imgPath" alt="查看" @click="menu2('/')">
                                       <!-- <img class="img-cur" src="../../../assets/default.jpg" alt="查看" @click="menu2('/')">-->
                                    </div>
                                   <!-- <Button type="text" ghost>删除</Button>-->
                                   <!-- <Button type="error" ghost>删除</Button>-->
                                     <!--<Button type="info" ghost>修改</Button>-->
                                    <Button type="info" @click="drop=true" ghost>修改</Button>
                                    <br>
                                    <span v-if="drop">
                                        <br>
                                    <editUploadPicInput @on-change="imgChange" :zhutuid="zhutuId"></editUploadPicInput>
                                    </span>
                    ...
                    <div class="footer">
<br><br>
                        <Button  type="primary" @click="value3 = false,drop=false">确定</Button>
                    </div>
                </Drawer>
            </div>
        </div>
...
<script>
    ...
    import carousel from "@/views/jiuqiVue/myTemplate/carousel.vue";
    import MyUploadPicInput from "@/views/my-components/xboot/MyUploadPicInput";
    import editUploadPicInput from "@/views/jiuqiVue/myTemplate/editUploadPicInput";
   // import  uploadPicInput from "";
    export default {
            ...
            return {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: (h, params) => {
                            let re = "";
                            if (params.row.newsIsTop == 1) {
                                re = "否";
                            } else if (params.row.newsIsTop == 0) {
                                re = "是";
                            }
                            return h("div", re);
                        }
        ...
        methods: {
            ...
            addSystem() {
                //在添加新闻时将新闻内容置空，避免在添加表单中显示其他新闻内容 begin
               this.newForm.newsConten="";
                //在添加新闻时将新闻内容置空，避免在添加表单中显示其他新闻内容 end
            ...
            editPerm(v) {
                ...
                getNewById(v.id).then(res => {
                    ...
                    if (res.success == true) {
                        ...
                        this.istop.newIsTop=this.newXQ.newsIsTop+"";
            ...
            zhutu(v){
                this.value3=true;
                //将主图对应的新闻id存储在变量中用于后续的删除动作
                this.zhutuId=v.id;
                //获取图片链接信息
                getImgsByNewsIds(v.id).then(res => {
                    this.operationLoading = false;
                    if (res.success == true) {
                        //this.$Message.success("操作成功");
            ...
            imgChange(v){
               //重新上传图片后刷新图片地址
                ...
                getImgsByNewsIds( this.zhutuId).then(res => {
                    this.operationLoading = false;
                    if (res.success == true) {
                        //this.$Message.success("操作成功");
                        this.imgPath=res.result;
