                ...
                <Card>
                    ...
                    <Row>
                        ...
                        <Form ref="subsystemNews"  :model="subsystemNews" inline :label-width="70" class="search-form">
                            <Form-item label="公文标题" prop="username">
                                <Input
    ...
    export default {
        ...
        data() {
            return {
                ...
                ,
                //add nijianping for jiuqi-公文 20190715 end 
                roleFormValidate: {
        ...
        methods: {
            ...
            getRoleList() {
                ...
                getSubsystemNotice(this.subsystemNews).then(res => {
                    this.loading = false;
                    if (res.success == true) {
