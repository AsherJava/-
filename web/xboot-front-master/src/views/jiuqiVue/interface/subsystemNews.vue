    ...
    <div class="search">
                ...
                <Card>
                    ...
                    <Row>
                        ...
                        <Form ref="subsystemNews"  :model="subsystemNews" inline :label-width="70" class="search-form">
                            <Form-item label="新闻标题" prop="username">
                                <Input
        ...
        <Modal :title="modalTitle" v-model="roleModalVisible" :mask-closable='false' :width="500">
            <Form ref="editSubsystemNews" :model="editSubsystemNews" :label-width="80" :rules="editSubsystemNewsValidate">
                ...
                <FormItem label="数据来源" prop="">
                    <Input v-model="editSubsystemNews.source"  placeholder="数据源"/>
                </FormItem>
        ...
        <Modal :title="BJmodalTitle" v-model="BJModalVisible" :mask-closable='false' :width="500">
            ...
            <Form ref="newXQ" :model="newXQ" :label-width="80" :rules="sysFormValidate">
                ...
                <FormItem label="新闻url" prop="description">
                    <Input v-model="newXQ.url"  placeholder="描述" />
                </FormItem>

                <FormItem label="数据来源" prop="">
                    <Input v-model="newXQ.source"  placeholder="来源" />
                </FormItem>
...
<script>
    import {
        editSubsystemNews,
        getSubsystemNewsById,
        addSubsystemNews,
        delSubsystemNews,
        getSubsystemNews,//条件查询新闻
        getNewById,//根据id查询新闻
        deleteNew,//删除新闻
        addNews,
        addSystem,
        ...
        methods: {
            ...
            getRoleList() {
              ...
              /*  this.subsystemNews.title="test";
                ...
                getSubsystemNews(this.subsystemNews).then(res => {
                    this.loading = false;
                    if (res.success == true) {
                ...
                this.$refs.editSubsystemNews.validate(valid => {
                    if (valid) {
                        if (this.modalType == 0) {
                            ...
                            addSubsystemNews(this.editSubsystemNews).then(res => {
            ...
            remove(v) {
                this.$Modal.confirm({
                    ...
                    onOk: () => {
                        ...
                        delSubsystemNews(v.id).then(res => {
