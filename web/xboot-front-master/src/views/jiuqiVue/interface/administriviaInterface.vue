    ...
    <div class="search">
                    ...
                    <Row>
                        <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
                            ...
                            <Form-item label="部门" prop="department">
                                <queryDepartmentXL :reset="chongzhi" @on-change="handleSelectDep" style="width: 200px" ref="dep"></queryDepartmentXL>
                            </Form-item>
                            <span v-if="drop">
        ...
        >
            <Form ref="userForm" :model="userForm" :label-width="70" :rules="userFormValidate">
                <FormItem label="test" prop="username">
                    <Input v-model="userForm.test" autocomplete="off"/>
                </FormItem>
