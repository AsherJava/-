        ...
        methods: {
            ...
            handleSuccess(res, file) {
                ...
                if (res.success == true) {
                    this.info();
                    file.url = res.result;
                    this.newImage=res.result;
                    //this.currentValue="上传成功"+res.result.oldName;
                   // this.currentValue = res.result;
                    this.$emit("input", this.currentValue);
                    this.$emit("on-change", this.currentValue);
                    //njp 20190717 向父组件中传值 begin
                    this.$emit("func",this.newImage);
                    //njp 20190717 向父组件中传值 end
